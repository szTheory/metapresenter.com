...
# gem 'middleman-disqus' #comments with disqus
# gem 'middleman-apps' #add rack-based children apps for api content
# gem 'middleman-alias' #alias/redirect for your pages and posts
# gem 'middleman-build-info' #build number/date
# gem 'middleman-automatic-clowncar' #responsive image thumbnails
